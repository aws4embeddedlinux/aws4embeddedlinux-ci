...
function addNagSuppressions(_stack: EmbeddedLinuxCodePipelineStack, _props: EmbeddedLinuxCodePipelineProps) {
...
describe("EmbeddedLinuxCodePipelineStack cdk-nag AwsSolutions Pack", () => {
  ...
  beforeAll(() => {
    ...
    const pipelineOutputBucket = new s3.Bucket(common, `${resource_prefix}-out`, {},);
